...
let
 ...
 writeStrictShellScriptBin = name: text:
  ...
  authorizedBackupKeys = [
    ...
    ''ssh-rsa  john@europa''
  ];
...
dockerTools.buildLayeredImage {
  ...
  tag = dockerTag;
  contents = [ rbreceive utillinux bashInteractive openssh btrfsProgs coreutils ./container-root ];
